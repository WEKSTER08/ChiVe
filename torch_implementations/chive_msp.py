...
if __name__ == "__main__":
    ...
    files  = os.listdir("../Data_prep/data/audio")
    f_c_inp  = []
    f_cav_inp  = []
    ...
    for i,file in enumerate(files):
        if i == 7: break
        print(i)
        f_c_inp.append(extract_f_c("../Data_prep/data/audio/"+file,0))
        # print(len(f_c_inp),len(f_c_inp[0]))
        f_cav_inp.append(extract_f_c("../Data_prep/data/audio/"+file,1))
    # print(f_c_inp)   
    ...
    files  = os.listdir("../Data_prep/data/syllable")
    outs = []
    data_len = 4096
    for i,file in enumerate(files):
        if i == 7: break
    ...
    files  = os.listdir("../Data_prep/data/phone")
    outs_ph = []
    data_len = 4096
    for i,file in enumerate(files):
        if i == 7: break
        # print(file)
        with open("../Data_prep/data/phone/"+file, "r") as outfile:
            data = outfile.readlines()
        # data = loadmat("../Data_prep/data/phone/"+file)
